...
[_RAISE] = KEYMAP( \
  ...
  _______, _______, _______, _______, MO(_BRACKETS), XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______ \
),
...
[_LOWER] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX,       MO(_BRACKETS), _______, _______,       _______, _______ \
),
