...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT_60_iso(
            ...
            KC_LCTL, KC_LGUI, KC_LALT,                           KC_SPACE,                            KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT \
            ),
    ...
    [_FN] = LAYOUT_60_iso(
            ...
            _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WDLF, KC_PGDN, KC_PGUP, KC_WDRT, XXXXXXX, XXXXXXX, \
