...
[_QWERTY_MAC] = LAYOUT_ortho_4x12( \
  ...
  KC_TAB,  KC_A, KC_S,    KC_D,    KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
  KC_LCTL, FNS,  KC_LALT, KC_LGUI, LOW_M, KC_SPC, KC_ENT, RAI_M, KC_RGUI, KC_RALT, FNS,     KC_RCTL \
),
...
[_LOWER_MAC] = LAYOUT_ortho_4x12( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MA_HOME, KC_PGDN, KC_PGUP, MA_END,  XXXXXXX, KC_DEL, \
  LINUX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MA_WDLF, KC_PGDN, KC_PGUP, MA_WDRT, XXXXXXX, _______, \
  _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______ \
),
